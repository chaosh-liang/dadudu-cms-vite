...
export const fetchSeriesByCategoryId = (id: string) =>
  service.getData(`${ALL_CATEGORY_URL}/${id}`)
export const fetchSeries = (category_id: string) =>
  service.getData(`${ALL_SERIES_URL}/${category_id}`)

export const addCategory = (data: CategoryT) =>
  service.postData(ADD_CATEGORY, data)
